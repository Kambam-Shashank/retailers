...
import { CatalogSettings } from "@/components/RateSetup/CatalogSettings";
import {
  GSTSettingsCard,
  MakingChargesCard,
  MarginsCard,
...
export default function RateSetupScreen(): ReactElement {
  ...
  } = useRateSetup(localConfig, handleLocalUpdate);
...
const styles = StyleSheet.create({
  ...
  stickyPreview: {
    width: "100%",
    // Add sticky positioning for web environments (React Native Web)
